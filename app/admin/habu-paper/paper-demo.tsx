...
export default function PaperDemo({ initialSheets }: { initialSheets: Sheet[] }) {
  ...
  return <div className="hp-app">
    ...
    <Tabs value={view} onValueChange={setView}>
      <div className="hp-top-nav hp-no-print"><TabsList><TabsTrigger value="inbox"><Inbox size={16} /> My work <span className="hp-count">{readyCount}</span></TabsTrigger><TabsTrigger value="sheets"><FileText size={16} /> All sheets</TabsTrigger><TabsTrigger value="sheet">{sheet.id} · Sheet</TabsTrigger></TabsList><Link href="/admin/habu-demo" className="hp-text-link">Original subway demo ↗</Link></div>
